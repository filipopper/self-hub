      ...
      <section class="hero">
        ...
        <div class="hero-inner">
          <div class="hero-text">
            ...
            <h1 class="hero-title">Libertad.<br>Justicia.<br>Mérito.</h1>
            <p class="hero-lead">Concejal del Municipio de Canelones (2025–2030). Paleolibertario. Defensor de la propiedad privada, la descentralización del poder y la soberanía individual.</p>
          ...
          <div class="hero-badge-stack" aria-hidden="true">
            <div class="hero-badge">
              ...
              <span>Concejal Municipal</span>
              <small>2025–2030</small>
            </div>
            <div class="hero-badge emerald">
              <i class="ri-heart-line"></i>
              <span>Ad honórem</span>
              <small>Sin percepción salarial</small>
            </div>
            <div class="hero-badge amber">
              <i class="ri-flag-line"></i>
              <span>Partido Nacional</span>
              <small>Paleolibertario</small>
            </div>
          </div>
        </div>
      </section>
